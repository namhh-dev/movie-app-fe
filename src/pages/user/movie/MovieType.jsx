...
export default function MovieType() {
  ...
  const type = context.types.filter((type)=>type.type_slug==typeSlug);
  ...
  const fetchMovie = async(page) => {
    setIsLoading(true);
      try {
          const data = await getMovieByType(typeSlug, page);
